...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Booking.book_type'
        db.add_column(u'booking_booking', 'book_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Booking.book_type'
        db.delete_column(u'booking_booking', 'book_type')
    ...
    models = {
        ...
        'booking.booking': {
            'Meta': {'ordering': "['-date_created']", 'object_name': 'Booking'},
            ...
            'book_type': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'pay_method': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
