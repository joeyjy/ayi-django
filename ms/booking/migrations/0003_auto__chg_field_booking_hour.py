...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Booking.hour'
        db.alter_column(u'booking_booking', 'hour', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Booking.hour'
        db.alter_column(u'booking_booking', 'hour', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'booking.booking': {
            'Meta': {'ordering': "['-id']", 'object_name': 'Booking'},
