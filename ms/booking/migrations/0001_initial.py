...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'booking_booking', (
            ...
            ('booker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('clean_ayi', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Ayi'], null=True, blank=True)),
            ('clean_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('bedroom', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('bathroom', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('laundry', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
    ...
    models = {
        ...
        'booking.booking': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'laundry': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
