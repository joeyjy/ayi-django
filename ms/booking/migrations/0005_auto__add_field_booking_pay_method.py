...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Booking.pay_method'
        db.add_column(u'booking_booking', 'pay_method',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Booking.pay_method'
        db.delete_column(u'booking_booking', 'pay_method')
