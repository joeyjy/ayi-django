...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ayi.pic'
        db.add_column(u'accounts_ayi', 'pic',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ayi.id_num'
        db.add_column(u'accounts_ayi', 'id_num',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ayi.street_num'
        db.add_column(u'accounts_ayi', 'street_num',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ayi.street'
        db.add_column(u'accounts_ayi', 'street',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ayi.area'
        db.add_column(u'accounts_ayi', 'area',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ayi.mobile'
        db.add_column(u'accounts_ayi', 'mobile',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ayi.pic'
        db.delete_column(u'accounts_ayi', 'pic')

        # Deleting field 'Ayi.id_num'
        db.delete_column(u'accounts_ayi', 'id_num')

        # Deleting field 'Ayi.street_num'
        db.delete_column(u'accounts_ayi', 'street_num')

        # Deleting field 'Ayi.street'
        db.delete_column(u'accounts_ayi', 'street')

        # Deleting field 'Ayi.area'
        db.delete_column(u'accounts_ayi', 'area')

        # Deleting field 'Ayi.mobile'
        db.delete_column(u'accounts_ayi', 'mobile')
