...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ayi.id_num'
        db.alter_column(u'accounts_ayi', 'id_num', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Ayi.id_num'
        db.alter_column(u'accounts_ayi', 'id_num', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        u'accounts.ayi': {
            ...
            'id_num': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
