...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyProfile.street'
        db.add_column(u'accounts_myprofile', 'street',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 8, 10, 0, 0), max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MyProfile.street'
        db.delete_column(u'accounts_myprofile', 'street')
