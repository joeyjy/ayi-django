...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ayi.home'
        db.add_column(u'accounts_ayi', 'home',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ayi.work_place'
        db.add_column(u'accounts_ayi', 'work_place',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ayi.rate'
        db.add_column(u'accounts_ayi', 'rate',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ayi.notes'
        db.add_column(u'accounts_ayi', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ayi.home'
        db.delete_column(u'accounts_ayi', 'home')

        # Deleting field 'Ayi.work_place'
        db.delete_column(u'accounts_ayi', 'work_place')

        # Deleting field 'Ayi.rate'
        db.delete_column(u'accounts_ayi', 'rate')

        # Deleting field 'Ayi.notes'
        db.delete_column(u'accounts_ayi', 'notes')
