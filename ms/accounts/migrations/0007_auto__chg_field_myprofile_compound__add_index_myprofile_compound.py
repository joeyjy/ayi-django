...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'MyProfile.compound' to match new field type.
        db.rename_column(u'accounts_myprofile', 'compound', 'compound_id')
        # Changing field 'MyProfile.compound'
        db.alter_column(u'accounts_myprofile', 'compound_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Compound'], null=True))
        # Adding index on 'MyProfile', fields ['compound']
        db.create_index(u'accounts_myprofile', ['compound_id'])


    def backwards(self, orm):
        # Removing index on 'MyProfile', fields ['compound']
        db.delete_index(u'accounts_myprofile', ['compound_id'])


        # Renaming column for 'MyProfile.compound' to match new field type.
        db.rename_column(u'accounts_myprofile', 'compound_id', 'compound')
        # Changing field 'MyProfile.compound'
